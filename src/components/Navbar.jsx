...
const Navbar = () => {
    ...
    return (
        <nav className='w-full flex py-6 justify-between items-center navbar'>
            ...
            {/* for mobile, dynamic menu button */}
            <div className='flex-1  items-center justify-end sm:hidden flex'>
                ...
                mx-4 my-2 p-6 min-w-[140px] rounded-xl sidebar bg-black-gradient 
                `}>
